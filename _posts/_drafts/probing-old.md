...
<details>
    <summary>Show Sample Distribution</summary>
    <div class="row mt-3">
        <div class="col-sm mt-3 mt-md-0">
            {% include figure.liquid loading="eager" path="assets/img/blog/probing/sample_graph.png" class="img-fluid rounded z-depth-1" %}
        </div>
    </div>
    <div class="caption">
